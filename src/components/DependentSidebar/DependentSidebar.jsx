...
const SidebarContainer = styled.div`
  ...
  top: 0;
  left: 0;
  z-index: 99; /* Ensure sidebar is above content */
...
const DependentSidebar = () => {
  const location = useLocation();
  return (
    <SidebarContainer>
      <Logo src={logo} alt="Nana" />

      <MenuItem to="/dependent-home" active={location.pathname === "/dependent-home" ? 1 : 0}>
        <img src={homeIcon} alt="Home" />
        Home
      </MenuItem>

      {/* Placeholder routes for now */}      
      <MenuItem to="/dependent-buy" active={location.pathname === "/dependent-buy" ? 1 : 0}>
        <img src={buyIcon} alt="Buy" />
        Buy
      </MenuItem>

      <MenuItem to="/dependent-myaccounts" active={location.pathname === "/dependent-myaccounts" ? 1 : 0}>
        <img src={myAccountIcon} alt="My Accounts" />
        My Accounts
      </MenuItem>

      <MenuItem to="/dependent-transfer" active={location.pathname === "/dependent-transfer" ? 1 : 0}>
        <img src={transferMoneyIcon} alt="Transfer Money" />
        Transfer Money
      </MenuItem>

      <MenuItem to="/dependent-statements" active={location.pathname === "/dependent-statements" ? 1 : 0}>
