...
const CaregiverProfile = () => {
  ...
  const [userData, setUserData] = useState({
    ...
    createdAt: '',
    updatedAt: '',
    // Additional fields for caregiver functionality
    dependentsCount: '0',
  ...
  const handleCompleteProfile = () => {
    if (profileCompletion.missingFields.length > 0) {
      ...
      // If profile is complete, navigate to caregiver home
        ...
        <S.ProfileCard>
          <S.Section>
            ...
            <S.Grid>
              ...
              <S.InfoItem>
                <label>Role</label>
                <p style={{ color: '#185c37' }}>{userData.role || userData.accountType}</p>
              </S.InfoItem>
              <S.InfoItem>
                <label>Relation</label>
                <p>{userData.relation || 'Not specified'}</p>
              </S.InfoItem>
              <S.InfoItem>
